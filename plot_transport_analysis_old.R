...
# Let's add some debugging prints
print("Sample names in normalized counts:")
print(unique(colnames(norm_counts)))
print("Sample names in sample_info:")
print(rownames(sample_info))

# Create bar plot for each transporter
transporter_plot <- ggplot(transporter_data, 
    ...
    scale_fill_manual(values=c("DMEM"="lightgrey", "NB"="grey")) +
    theme_bw() +
    theme(
